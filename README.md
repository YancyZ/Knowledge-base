...
| [前端工程化体系](./前端工程化体系/) | 包管理、构建、质量、交付、安全等 | **14 篇** |
...
12 篇独立成文，覆盖从依赖安装到上线观测的全链路；另增测试方法论与框架工程化实践 2 篇。

| 序号 | 文档 | 主题 |
|------|------|------|
| 01 | [包管理层](./前端工程化体系/01-包管理层.md) | Node、pnpm/npm、SemVer、lock |
| 02 | [模块化与构建层](./前端工程化体系/02-模块化与构建层.md) | ESM/CJS、Webpack/Vite、React Compiler |
| 03 | [脚手架与项目初始化](./前端工程化体系/03-脚手架与项目初始化.md) | 模板、Monorepo、React/Vue 选型 |
| 04 | [代码规范与质量保障](./前端工程化体系/04-代码规范与质量保障.md) | ESLint、Prettier、测试配置 |
...
| 09 | [微前端与模块联邦](./前端工程化体系/09-微前端与模块联邦.md) | Module Federation、架构选型 |
...
| 13 | [前端测试方法论](./前端工程化体系/13-前端测试方法论.md) | 金字塔、Mock、覆盖率、CI |
| 14 | [框架工程化实践](./前端工程化体系/14-框架工程化实践.md) | React/Vue 工具链、类型检查、升级 |

**主题分组**：环境与依赖（01）→ 构建（02～03）→ 质量（04、13）→ 交付与运行（05～08）→ 架构与体验（09～12）→ 框架工程化（14）。
