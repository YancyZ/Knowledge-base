...
个人知识体系，涵盖**前端基础**、**前端框架**与**前端工程化**三大模块。文档通用、普适，可按主题选读。
...
├── 前端框架篇/            # React · Vue · React Native · Flutter · Uni-app
...
| [前端框架篇](./前端框架篇/) | React / Vue 等框架实践与编码规范 | React 85 篇 + Vue 规范 |
| [前端工程化体系](./前端工程化体系/) | 现代前端工具链、规范与实践 | 12 篇 |
...
> React、Vue 等主流框架的实践笔记与编码规范；React Native、Flutter、Uni-app 等跨端方向持续补充。

| 框架 | 文档 | 说明 |
|------|------|------|
| React | [00-阅读地图](./前端框架篇/React/00-阅读地图.md) · [编码规范](./前端框架篇/React/React编码规范.md) | **20 模块 / 84 篇正文**（01～20 + 阅读地图） |
| Vue | [Vue 编码规范](./前端框架篇/Vue/Vue编码规范.md) | Vue 3 / Composition API / TypeScript |
| React Native | — | 待补充 |
| Flutter | — | 待补充 |
| Uni-app | — | 待补充 |
...
**质量与规范** — 04 代码规范与质量保障（框架编码规范见 [前端框架篇](#前端框架篇)）  
