...
> 目录按模块组织 React 18+ 的学习笔记：从组件、Hooks 到并发、RSC 与生产排障。各章独立成篇，开篇点题、文末 **小结**；正文用自然叙述串联概念、动机与做法，不依赖跨章跳转。
...
| 区块 | 模块 | 内容侧重 |
|------|------|----------|
| **P0 入门** | 01～06 | 组件、Hooks、渲染与调和 |
| **P1 架构** | 07～13 | 模式、状态、数据、路由、性能、并发、TS |
| **P2 生产** | 14～20 | SSR、测试、a11y、迁移、React 19、跨端、排障 |
| **规范** | 编码规范 | 团队工程约定（独立文档） |
