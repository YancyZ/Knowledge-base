...
## 四、connect / mapStateToProps（Redux 旧）
...
RTK 推荐 typed hooks，见 [08-Redux](../08-状态管理/04-Redux-Toolkit与RTK-Query.md)。

---

## 五、defaultProps 与 PropTypes
...
写入 [React编码规范](../React编码规范.md) 或团队 wiki。
...
面试点见 [20-面试串联](../20-排障与生产实践/04-面试题串联与答题框架.md)（P2-c）。
...
**上一篇**：[04-类组件迁移策略与步骤](./04-类组件迁移策略与步骤.md)  
**下一模块（P2-c）**：[18-React19与新特性](../18-React19与新特性/01-React19要点.md)
