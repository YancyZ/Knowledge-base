...
> **目标**：让生产环境的前端行为可感知、可追踪、可快速定位与修复问题。
...
- [ ] Error Boundary 分层  
- [ ] Sentry（或同类）接入，release 版本对齐  
- [ ] Source Map 上传、CDN 不暴露  
- [ ] beforeSend 脱敏  
- [ ] Web Vitals RUM 分位 dashboard  
- [ ] 告警规则 + Runbook  
- [ ] 新功能上线 24h 错误率/watch  
...
可观测性让「用户报错但我无法复现」变成可检索的 issue 与栈信息。错误监控抓异常，RUM 抓体验，Source Map 还原现场，结构化日志与 traceId 串联全链路。上线不是终点 — 没有监控的发布是 blind deploy。
