...
构建层负责将 TypeScript、JSX、Vue SFC 等源码转为浏览器可运行的生产资源。ESM 是现代模块标准；Vite 以开发体验见长，Webpack 生态最完整；Tree-shaking、代码分割与 Source Map 策略直接影响包体积与排障效率。
